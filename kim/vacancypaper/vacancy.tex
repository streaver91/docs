...
To see how the total interaction energy changes, we first notice the strength of $\widetilde{\epsilon}_I$ is proportional $n_d$ because of the superposition in linear elasticity.
