...
\title{
 Monovacancy Properties of FCC and HCP Structures\\
 From Automated Atomistic Simulation Based on OpenKIM
...
\begin{abstract}
The quality of interatomic models is crucial to atomistic simulations.
In this study, we assess the interatomic models in terms of their ability to describe vacancy-related interactions.
Based on the OpenKIM framework, we perform automated atomistic calculations of monovacancy properties, including the formation energy, the migration energy, and the relaxation volume, for all the interatomic models currently available in the OpenKIM repository, and compare the calculation results with reference data from density functional (DFT) calculations and experiments to identify the most promising interatomic models for defect-related simulations.
We also explore how the monovacancy properties relate to each other, and to other elemental properties.
