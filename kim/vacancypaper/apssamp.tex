...
And in metrology, some scientists are proposing using \ce{^{28}Si} for a new kilogram definition, and obtaining the vacancy concentration is a crucial part of this work.
...
In order to assess how each interatomic potential model performs in vacancy-related simulations, we calculated the most important monovacancy properties for all the elements and all the simple crystal structures predicted by the interatomic potential models available on OpenKIM at this time.
...
All of these results are consistent with physics intuition and previous literatures \cite{angsten2014elemental}.
These relationships can provide additional information in selecting models and screening structures.

The paper is organized as follows.
In Sec.~\ref{sec:method} we describe the method we used for calculating the monovacancy properties.
...
% \begin{ruledtabular}
% \begin{tabular}{c | c | c}
%   \multicolumn{3}{c}{Formation Energy versus Cohesive Energy} \\
...
We got consistent results with physics intuition and previous studies, which further proved the reliability of our results and these relationships.
