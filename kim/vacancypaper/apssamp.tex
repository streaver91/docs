...
The entropic effects of vibrations at the ground state and saddlepoint, needed for the complete transition-state estimate for the prefactor of the diffusion constant~\cite{Hanggi}, will in general depend upon whether the system described is a classical simulation or a quantum solid, and goes beyond the purview of our work here.
