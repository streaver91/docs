...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c12 = function(identifier, value) {
        return {
          name: identifier,
          value: value
        };
  ...
  function peg$parseNumberValue() {
    ...
    s0 = peg$currPos;
    s1 = peg$parseScientificNotation();
    if (s1 === peg$FAILED) {
      s1 = peg$parseDecimal();
      if (s1 === peg$FAILED) {
        s1 = peg$parseInteger();
  ...
  function peg$parseScientificNotation() {
    var s0, s1, s2, s3;
